...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  {
    id: 'p38',
    name: 'Nomad Water Resistant Pouch',
    sku: 'NWRP-MINI',
    price: 35.00,
    inventory: 75,
    status: 'Trained',
